...
class UrlRecognizer extends PatternRecognizer {
    ...
    static PATTERNS = [
        new Pattern(
            "Standard Url",
            new RegExp("(?:https?:\\/\\/)" + UrlRecognizer.BASE_URL_REGEX, "i"),
            0.6
        ),
        new Pattern(
            "Non schema URL",
            new RegExp(UrlRecognizer.BASE_URL_REGEX, "i"),
            0.5
        ),
        new Pattern(
            "Quoted URL",
    ...
    constructor({
        ...
        super({
            supportedEntity,
            patterns: patterns || UrlRecognizer.PATTERNS,
            context: context || UrlRecognizer.CONTEXT,
            supportedLanguage,
            name
        });
    }
...
module.exports = { Pattern, PatternRecognizer, UrlRecognizer };